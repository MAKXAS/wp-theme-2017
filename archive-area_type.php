...
<!--breadcrumb-->
    ...
    <div class="bread-crumb">
      <?php if(function_exists('bcn_display')) { bcn_display(); }?>
       ...
       <form role="search" method="get" id="searchform" class="searchform hide-for-small-only" action="http://kaitorimakxas.com/column/">
          <input type="text" value="" name="s" id="s">
          <!--<input type="hidden" name="post_type" value="model_top">-->
                    <input type="image" id="searchsubmit" alt="検索" width="32" height="30" src="http://kaitorimakxas.com/makxas_2017/wp-content/themes/makxas/common/img/column/icon-seach.png" placeholder="記事を検索">
        </form>
    </div>
    </div>
    </nav>
